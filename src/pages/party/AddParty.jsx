      ...
      {!showImage ? (
        <main className="w-full max-w-lg mx-auto mt-10 p-6 bg-white rounded shadow-lg">
          ...
          <div className="flex justify-between items-center mb-6 gap-4">
            ...
            >
              <span className="text-green-600 font-bold mb-2">파티장</span>
            ...
            >
              <span className="text-green-600 font-bold mb-2">파티원</span>
              <span className="text-center text-sm text-gray-600">
                계정을 공유받고 싶어요
              </span>
            </div>
          ...
          <button
            className="mt-6 bg-green-500 text-white py-3 px-8 rounded-full shadow-lg w-full hover:bg-green-600 transition-all duration-300"
        ...
        <div className="flex flex-col items-center justify-center mt-10">
          ...
          <button
            className="mt-4 bg-green-500 text-white py-3 px-8 rounded-full shadow-lg hover:bg-green-600 transition-all duration-300"
